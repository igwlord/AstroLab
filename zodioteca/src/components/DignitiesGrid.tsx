...
const DignitiesGrid: React.FC = () => {
  ...
  return (
    <div className="space-y-3 sm:space-y-4 md:space-y-6">
      {/* Descripción */}
      <div className="bg-gradient-to-r from-amber-50 to-yellow-50 dark:from-amber-900/20 dark:to-yellow-900/20 p-3 sm:p-4 md:p-5 lg:p-6 rounded-lg">
        ...
        <p className="text-xs sm:text-sm md:text-base text-gray-700 dark:text-gray-300 mb-2 sm:mb-3">
          ...
          su posición en el zodíaco. <span className="hidden sm:inline">Un planeta en buena dignidad actúa con naturalidad y poder; en mala 
          dignidad, encuentra <strong>obstáculos o se manifiesta incómodamente</strong>.</span>
        </p>
        <div className="bg-white/50 dark:bg-gray-800/50 p-2 sm:p-3 md:p-4 rounded-lg mt-2 sm:mt-3">
          <h4 className="text-xs sm:text-sm font-semibold text-gray-800 dark:text-gray-200 mb-1 sm:mb-2">⚖️ Dos Tipos Principales</h4>
          <ul className="text-[10px] sm:text-xs md:text-sm space-y-0.5 sm:space-y-1 text-gray-700 dark:text-gray-300">
            <li><strong>Esenciales:</strong> <span className="hidden sm:inline">Basadas en el signo (</span>domicilio, exaltación, exilio, caída<span className="hidden sm:inline">)</span></li>
            <li><strong>Accidentales:</strong> <span className="hidden sm:inline">Subdivisiones finas (</span>triplicidad, decanatos<span className="hidden sm:inline">, términos, faces)</span></li>
          </ul>
        </div>
      </div>
        ...
        {filteredDignities.map((dignity) => (
          ...
          >
            ...
            <div className="text-center">
              ...
              <p className="text-[10px] sm:text-xs opacity-90 mt-0.5 sm:mt-1">{dignity.chakra}</p>
            </div>
            <span className={`text-[10px] sm:text-xs ${
              dignity.name === 'Exaltación' ? 'bg-gray-800/20' : 'bg-white/20'
            } px-2 sm:px-3 py-0.5 sm:py-1 rounded-full mt-auto`}>
      ...
      {/* Tabla Comparativa */}
      <div className="bg-white dark:bg-gray-800 p-3 sm:p-4 md:p-5 lg:p-6 rounded-lg">
