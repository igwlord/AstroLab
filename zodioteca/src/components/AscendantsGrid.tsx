...
const AscendantsGrid: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      {/* Descripción */}
      <div className="bg-gradient-to-r from-orange-50 to-amber-50 dark:from-orange-900/20 dark:to-amber-900/20 p-6 rounded-lg">
        <h3 className="text-xl font-semibold mb-2 text-orange-900 dark:text-orange-200 flex items-center gap-2">
        ...
        <p className="text-gray-700 dark:text-gray-300">
          ...
          de abordar la vida. Es la puerta de entrada a tu carta natal.
        </p>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        {ASCENDANTS.map((ascendant) => (
          <button
            ...
            className={`bg-gradient-to-br ${getSignColor(ascendant.sign)} text-white p-6 rounded-xl shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-300 flex flex-col items-center gap-3`}
          >
            <span className="text-6xl">{ascendant.symbol}</span>
            <div className="text-center">
              <h3 className="font-bold text-lg">ASC en {ascendant.sign}</h3>
      ...
      <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg border-l-4 border-blue-500">
        <p className="text-sm text-gray-700 dark:text-gray-300">
          ...
          El Ascendente cambia aproximadamente cada 2 horas, por lo que incluso una diferencia de minutos puede cambiar tu signo ascendente.
        </p>
      </div>
