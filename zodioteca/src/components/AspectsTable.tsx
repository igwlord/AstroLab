                  ...
                  {typeAspects.map((aspect, idx) => (
                    <tr key={idx} className="border-b border-current opacity-30 last:border-0 hover:bg-white/50 dark:hover:bg-black/20">
                      <td className="py-2 px-2 font-semibold">
                        <span className="text-base mr-1" style={{ fontFamily: '"Zodiac Symbols", "Zodiac Symbols Fallback", "Noto Sans Symbols 2", "Segoe UI Symbol", Arial, sans-serif' }}>
                      ...
                      <td className="text-center py-2 px-2">
                        <span className="text-xl font-bold" style={{ fontFamily: '"Zodiac Symbols", "Zodiac Symbols Fallback", "Noto Sans Symbols 2", "Segoe UI Symbol", Arial, sans-serif' }}>
                          {info.symbol}
